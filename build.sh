...
# Fix mptcpd compilation on kernel 6.1+ by applying patch
if [ -d feeds/openmptcprouter/mptcpd ]; then
    echo "Applying mptcpd fix patch..."
    mkdir -p feeds/openmptcprouter/mptcpd/patches
    cp ../../../patches/mptcpd-fix-events.patch feeds/openmptcprouter/mptcpd/patches/900-fix-events.patch
fi
